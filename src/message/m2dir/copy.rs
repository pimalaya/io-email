...
//! must follow up with [`EmailClientStd::store_flags`].
//!
//! [`EmailClientStd::store_flags`]: crate::client::EmailClientStd::store_flags
//!
//! # Example
//!
//! ```rust,ignore
//! use io_email::message::m2dir::copy::M2dirMessageCopy;
//!
