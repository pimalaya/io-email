...
//!
//! Surfaced by the watch-mailbox API as a continuous stream. Each
//! variant is the pre-diffed delta the backend observed: envelopes
//! added or removed from the watched mailbox, and per-message flag
//! additions or removals computed against the watcher's in-memory
//! shadow.
